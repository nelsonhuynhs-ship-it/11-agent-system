# Email Dashboard v6 — Master Overview

**Last updated:** 2026-04-22 23:00
**Status:** ✅ VERIFIED LIVE (Phase 1 Data Migration complete + Production Batch Validated)
**Plan:** `plans/260422-1800-email-dashboard-v6-master/`
**Dashboard UI:** `plans/visuals/email-dashboard-v6.html`
...
- **Email** — Optimized với daily rotation engine + anti-spam 5-layer
- **WhatsApp** — Meta Cloud API direct (sandbox $0 tuần 1 → $20/tháng production)
- **LinkedIn** — Sales Nav hybrid (deferred Phase 6)

Với master data **2-sheet tách riêng CNEE/SHIPPER**, bảo vệ priority customer, auto-harvest decision makers từ auto-reply.
...
## Architecture — Email Pipeline v6

```
MASTER DATA (2-sheet):
  D:/OneDrive/NelsonData/email/contact_unified_v6.xlsx
  ├─ Sheet "CNEE" — 22,230 rows, active send
  │   Cols: EMAIL, COMMODITY_CATEGORY, TIMEZONE, EMAIL_STATUS,
  │          SEND_COUNT, LAST_SENT_DATE, REPLY_STATUS, TIER, ...
  └─ Sheet "SHIPPER" — 5-8K rows, HOLD until VN blacklist ready
      (Same 35-col schema, different audience)
...
|------|---------|-----|--------|
| `scripts/panjiva_clean_v2.py` | Extract 15-col Panjiva + split CNEE/SHIPPER | 197 | ✅ |
| `scripts/migrate-to-unified-v6.py` | Merge 5 files → 2-sheet master | 199 | ✅ |
...
| `email_engine/config/rotation_quota.json` | Commodity quota config | — | ✅ |
| `plans/visuals/email-dashboard-v6.html` | 8-tab UI | — | 🔨 Updating |
| `docs/SYSTEM_STANDARDS.md` | Section 6.5 Anti-Spam added | — | ✅ |
| `docs/EMAIL_PIPELINE_SOURCE_OF_TRUTH.md` | v6 architecture updated | — | ✅ |
| `docs/EMAIL_DASHBOARD_V6.md` | This file (master overview) | — | ✅ |
| `docs/DAILY_ROTATION_ENGINE.md` | Rotation engine specific doc | — | 🔨 Creating |

---

## Success Metrics (v6 Target)

| Metric | Baseline (v4) | Target (v6) | Current |
|--------|-----------|-------------|---------|
| Email open rate | 3.7% | 12–15% | TBD |
| Send volume/day | 200–300 | 700 weekday | ✅ |
| Per-recipient max sends | Uncontrolled | 3/30d hard limit | ✅ |
| Typo silent sends | 345 /month | 0 | ✅ |
| Pool size (CNEE) | 22,230 | 25–28K clean | ✅ |
| Data files | 7 scattered | 1 master 2-sheet | ✅ |
| Pool size (SHIPPER) | 0 (mixed) | 5–8K separate | ✅ |
...
- [Email Pipeline Source of Truth](./EMAIL_PIPELINE_SOURCE_OF_TRUTH.md) — Canonical architecture
- [System Standards Section 6.5](./SYSTEM_STANDARDS.md) — Anti-spam rules
- [Plan: v6 Master](../plans/260422-1800-email-dashboard-v6-master/plan.md) — Full roadmap
- [Plan: Daily Rotation](../plans/260422-2100-daily-rotation-engine/plan.md) — Rotation details
